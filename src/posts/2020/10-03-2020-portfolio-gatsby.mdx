...
If you're interested in reading my code which has been used to generate this site, here is a link to my [GitHub repository](https://github.com/PatrickWhitehouse/gatsby-portfolio).